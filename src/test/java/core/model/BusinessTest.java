...
class BusinessTest {
    ...
    public void setup() throws Exception{
        business = new Business(mockDatabase);
        length = 15;
        name = "test";
    ...
    void emptyName(){
        name = "";
        result = business.addNewService(name, length);
    ...
    void addService() throws Exception{
        ...
        assertEquals(SUCCESS_WRITE, business.addNewService(name, length));
    }
    ...
    void addServiceFailedAddToDatabase() throws Exception{
        ...
        assertEquals(FAILED_WRITE, business.addNewService(name, length));
    }
